...
const HomeAdmin = () => {
  ...
  const itemSize = screenWidth / numColumns - scale(30);
  const services = [
    ...
    { id: "5", name: "Check Namaj", icon: require("../../assets/Icon/Notify.png"), Tab: "SalatSaved" },
  ];
          ...
          <>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              <View style={styles.header}>
                ...
                <Text style={{ fontSize: moderateScale(20), fontFamily: "SemiBold", color: theme.heading }}>
                  {name}
                </Text>
              </View>
            ...
            <Text style={{ fontSize: 16, fontFamily: "Bold", color: theme.primary, marginLeft: 10 }}>Featured</Text>
